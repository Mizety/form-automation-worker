    ...
    async def test_links_integration(self, url):
        ...
        try:
            ...
            try:
                ...
                detected_url = await url_locator.input_value()
    ...
    async def run_test(self, url):
        ...
        try:
            ...
            try:
                ...
                print(f"Error in test_links_integration: {e}")
            finally:
...
async def main(url):
    ...
    await check.run_test(url)

if __name__ == "__main__":
    asyncio.run(main("https://www.google.com/maps/contrib/102614850577731744343/place/ChIJRYcmrSFxsEcRwfSHxlsSV8I/@52.4077888,9.6600101,12z/data=!4m6!1m5!8m4!1e1!2s102614850577731744343!3m1!1e1?hl=de&entry=ttu&g_ep=EgoyMDI1MDMxOS4xIKXMDSoJLDEwMjExNDUzSAFQAw%3D%3D"))